                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="edit_restaurant.php?id=<?php echo $row['res_id']; ?>"
                                                        class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                                                    <a href="delete_restaurant.php?id=<?php echo $row['res_id']; ?>"
                                    ...
                                    <nav aria-label="Pagination">
                                        <ul class="pagination justify-content-center">
                                            ...
                                            <li class="page-item">
                                                <a class="page-link"
                                                    href="?page=<?php echo $page - 1; ?>&name=<?php echo $name; ?>&description=<?php echo $description; ?>&address=<?php echo $address; ?>&phone_number=<?php echo $phone_number; ?>"
                                                    aria-label="Previous">
                                            ...
                                            <li class="page-item <?php echo $i == $page ? 'active' : ''; ?>">
                                                <a class="page-link"
                                                    href="?page=<?php echo $i; ?>&name=<?php echo $name; ?>&description=<?php echo $description; ?>&address=<?php echo $address; ?>&phone_number=<?php echo $phone_number; ?>">
                                                    <?php echo $i; ?>
                                                </a>
                                            </li>
                                            <?php endfor; ?>
